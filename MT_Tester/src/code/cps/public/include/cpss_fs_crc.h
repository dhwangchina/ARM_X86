...
#define CRC32_DEFAULT  0xdebb20e3 /*0x04C10DB7*/
...
返回值 说明： 循环冗余校验结果
*******************************************************************/
extern unsigned short RunCRC16( const unsigned char * aData, unsigned long aSize, unsigned short aPoly );
/*******************************************************************/
/*
函 数 名 称: RunCRC32
...
参 数 说 明：aData[in]:待校验数据
            ...
            aPoly[in]:创建表所需要的多项式
*******************************************************************/
extern unsigned long  RunCRC32( const unsigned char * aData, unsigned long aSize, unsigned long  aPoly );
/*
CRC算法简介：
...
extern unsigned long CalcCRC32(const unsigned char * pBuffer, long length) ;
